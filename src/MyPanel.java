...
public class MyPanel extends JPanel {
	...
	// free draw class
	public static class Free implements Graph {
	...
	// line class
	public static class Line implements Graph {
	...
	// oval class
	public static class Oval implements Graph {
		int x1, y1, x2, y2, color, stroke;
	...
	// rectangle class
	public static class Rect implements Graph {
		int x1, y1, x2, y2, color, stroke;
	...
	// eraser class
	public static class Eraser implements Graph {
		int x, y, stroke;
	...
	//image class
	public static class Image implements Graph{
		String path;
